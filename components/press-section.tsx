...
const articles = [
  ...
  },
  {
    ...
    modalDesc:
      "영등포 종도의과 원장 김정길 원장과 대장항문과 전문의가 공동 서명한 공식 추천서입니다. 중앙집중식 회전기포 물줄기를 이용한 분사 노즐 개발로 배변 시간을 줄이고 강한 변의를 통해 쾌변과 손쉬운 관장을 유도하며, 항문 괄약근의 건강 상태를 향상시킨다는 이젠누리에 대한 임상 소견을 담고 있습니다.",
  },
  {
    id: 3,
